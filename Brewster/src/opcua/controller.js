...
export async function startProductionController(
    batchId,
    beerType,
    batchSize,
    productionSpeed
) {
    return await production.startProduction(
        batchId,
        beerType,
        batchSize,
        productionSpeed
...
export async function getProductionResultsController() {
    return await production.getProducedAmount();
}
...
export async function getMachineStatusController() {
    return await connection.getMachineStatus();
}
